...
class ForwardList
{
    struct Node
    {
        using pointer = typename Allocator<Node>::pointer;
        T data;
        pointer next;
...
public:
    ...
    using pointer = typename NodeAllocator::pointer;
    using const_pointer = const typename NodeAllocator::pointer;
    ...
    ForwardList(const ForwardList &other) : _head(nullptr)
    {
        pointer *tail = &_head;
    ...
    ForwardList(ForwardList &&other) : _head(nullptr)
    {
        _head = other._head;
        other._head = nullptr;
    }
    ...
    explicit ForwardList(size_t count, const T &value = T()) : _head(nullptr)
    {
        pointer *tail = &_head;
    ...
    ForwardList(std::initializer_list<T> list) : _head(nullptr)
    {
        pointer *tail = &_head;
    ...
    ForwardList &operator=(std::initializer_list<T> list)
    {
        clear();
        pointer *tail = &_head;
        for (const T &value : list)
    ...
    void swap(ForwardList &other) noexcept { std::swap(_head, other._head); }

    void merge(ForwardList &other) { merge(other, std::less<T>()); }
...
typename ForwardList<T, Allocator>::NodeAllocator ForwardList<T, Allocator>::allocator{};
...
template <typename T, template <typename> class Allocator>
ForwardList<T, Allocator>::iterator ForwardList<T, Allocator>::insert_after(const_iterator pos, const_reference value)
{
...
template <typename T, template <typename> class Allocator>
ForwardList<T, Allocator>::iterator ForwardList<T, Allocator>::insert_after(const_iterator pos, T &&value)
{
    pointer node = pos._ptr;
    pointer new_node = allocator.allocate(1);
    if constexpr (std::is_trivially_move_constructible_v<T>)
...
template <typename T, template <typename> class Allocator>
ForwardList<T, Allocator>::iterator ForwardList<T, Allocator>::insert_after(const_iterator pos, size_type count,
...
template <typename T, template <typename> class Allocator>
template <class InputIt>
ForwardList<T, Allocator>::iterator ForwardList<T, Allocator>::insert_after(const_iterator pos, InputIt first,
                                                                            InputIt last)
{
    pointer node = pos._ptr;
...
template <typename T, template <typename> class Allocator>
ForwardList<T, Allocator>::iterator ForwardList<T, Allocator>::insert_after(const_iterator pos,
...
template <typename T, template <typename> class Allocator>
ForwardList<T, Allocator>::iterator ForwardList<T, Allocator>::erase_after(const_iterator pos)
{
...
template <typename T, template <typename> class Allocator>
ForwardList<T, Allocator>::iterator ForwardList<T, Allocator>::erase_after(const_iterator first, const_iterator last)
{
...
template <typename T, template <typename> class Allocator>
void ForwardList<T, Allocator>::splice_after(const_iterator pos, ForwardList &other)
{
...
template <typename T, template <typename> class Allocator>
void ForwardList<T, Allocator>::splice_after(const_iterator pos, ForwardList &other, const_iterator it)
{
...
template <typename T, template <typename> class Allocator>
void ForwardList<T, Allocator>::splice_after(const_iterator pos, ForwardList &other, const_iterator first,
                                             const_iterator last)
{
