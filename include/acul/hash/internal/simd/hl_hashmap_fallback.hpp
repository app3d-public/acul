...
namespace acul
{
    namespace internal
    {
        ...
        inline void masks64_tag_empty(uint8_t tag, const uint8_t *ctrl, uint32_t &m0, uint32_t &e0, uint32_t &m1, uint32_t &e1)
        {
        ...
        inline void ctrl_init_mask_from_current(const uint8_t *ctrl, size_t cap, size_t idx,
                                                    ctrl_scan_state_t *st)
        {
            const uint32_t BLK = 32;
