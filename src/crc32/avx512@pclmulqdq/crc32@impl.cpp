...
/* C:\Users\alekesej\Documents\Programming\Tests\fast-crc32\generate.exe -i avx512_vpclmulqdq -p crc32c -a
 * v12x2s16x5k64e */
/* MIT licensed */
...
extern "C"
{
    __declspec(dllexport) uint32_t crc32_impl(uint32_t crc0, const char *buf, size_t len)
    {
        ...
        if (len >= 2176)
        {
            ...
            __m512i x4 = _mm512_loadu_si512((const void *)(buf2 + 256)), y4;
            __m512i x5 = _mm512_loadu_si512((const void *)(buf2 + 320)), y5;
            __m512i x6 = _mm512_loadu_si512((const void *)(buf2 + 384)), y6;
            __m512i x7 = _mm512_loadu_si512((const void *)(buf2 + 448)), y7;
            __m512i x8 = _mm512_loadu_si512((const void *)(buf2 + 512)), y8;
            __m512i x9 = _mm512_loadu_si512((const void *)(buf2 + 576)), y9;
            __m512i x10 = _mm512_loadu_si512((const void *)(buf2 + 640)), y10;
            __m512i x11 = _mm512_loadu_si512((const void *)(buf2 + 704)), y11;
            __m512i k;
            k = _mm512_broadcast_i32x4(_mm_setr_epi32(0x8d96551c, 0, 0xd7a4825c, 0));
            ...
            x0 = _mm512_ternarylogic_epi64(x0, y0, _mm512_loadu_si512((const void *)(buf2 + 768)), 0x96);
            x1 = _mm512_ternarylogic_epi64(x1, y1, _mm512_loadu_si512((const void *)(buf2 + 832)), 0x96);
            x2 = _mm512_ternarylogic_epi64(x2, y2, _mm512_loadu_si512((const void *)(buf2 + 896)), 0x96);
            x3 = _mm512_ternarylogic_epi64(x3, y3, _mm512_loadu_si512((const void *)(buf2 + 960)), 0x96);
            x4 = _mm512_ternarylogic_epi64(x4, y4, _mm512_loadu_si512((const void *)(buf2 + 1024)), 0x96);
            x5 = _mm512_ternarylogic_epi64(x5, y5, _mm512_loadu_si512((const void *)(buf2 + 1088)), 0x96);
            x6 = _mm512_ternarylogic_epi64(x6, y6, _mm512_loadu_si512((const void *)(buf2 + 1152)), 0x96);
            x7 = _mm512_ternarylogic_epi64(x7, y7, _mm512_loadu_si512((const void *)(buf2 + 1216)), 0x96);
            x8 = _mm512_ternarylogic_epi64(x8, y8, _mm512_loadu_si512((const void *)(buf2 + 1280)), 0x96);
            x9 = _mm512_ternarylogic_epi64(x9, y9, _mm512_loadu_si512((const void *)(buf2 + 1344)), 0x96);
            x10 = _mm512_ternarylogic_epi64(x10, y10, _mm512_loadu_si512((const void *)(buf2 + 1408)), 0x96);
            x11 = _mm512_ternarylogic_epi64(x11, y11, _mm512_loadu_si512((const void *)(buf2 + 1472)), 0x96);
            buf2 += 1536;
            /* Main loop. */
            while (buf <= limit)
            {
                ...
                x4 = _mm512_ternarylogic_epi64(x4, y4, _mm512_loadu_si512((const void *)(buf2 + 256)), 0x96);
                x5 = _mm512_ternarylogic_epi64(x5, y5, _mm512_loadu_si512((const void *)(buf2 + 320)), 0x96);
                x6 = _mm512_ternarylogic_epi64(x6, y6, _mm512_loadu_si512((const void *)(buf2 + 384)), 0x96);
                x7 = _mm512_ternarylogic_epi64(x7, y7, _mm512_loadu_si512((const void *)(buf2 + 448)), 0x96);
                x8 = _mm512_ternarylogic_epi64(x8, y8, _mm512_loadu_si512((const void *)(buf2 + 512)), 0x96);
                x9 = _mm512_ternarylogic_epi64(x9, y9, _mm512_loadu_si512((const void *)(buf2 + 576)), 0x96);
                x10 = _mm512_ternarylogic_epi64(x10, y10, _mm512_loadu_si512((const void *)(buf2 + 640)), 0x96);
                x11 = _mm512_ternarylogic_epi64(x11, y11, _mm512_loadu_si512((const void *)(buf2 + 704)), 0x96);
                y0 = clmul_lo(x0, k), x0 = clmul_hi(x0, k);
                y1 = clmul_lo(x1, k), x1 = clmul_hi(x1, k);
                y2 = clmul_lo(x2, k), x2 = clmul_hi(x2, k);
                y3 = clmul_lo(x3, k), x3 = clmul_hi(x3, k);
            ...
            x4 = _mm512_ternarylogic_epi64(x4, y4, x5, 0x96);
            x6 = _mm512_ternarylogic_epi64(x6, y6, x7, 0x96);
            x8 = _mm512_ternarylogic_epi64(x8, y8, x9, 0x96);
            x10 = _mm512_ternarylogic_epi64(x10, y10, x11, 0x96);
            k = _mm512_broadcast_i32x4(_mm_setr_epi32(0x6992cea2, 0, 0x0d3b6092, 0));
            y0 = clmul_lo(x0, k), x0 = clmul_hi(x0, k);
            y4 = clmul_lo(x4, k), x4 = clmul_hi(x4, k);
            y8 = clmul_lo(x8, k), x8 = clmul_hi(x8, k);
            x0 = _mm512_ternarylogic_epi64(x0, y0, x2, 0x96);
            x4 = _mm512_ternarylogic_epi64(x4, y4, x6, 0x96);
            x8 = _mm512_ternarylogic_epi64(x8, y8, x10, 0x96);
            k = _mm512_broadcast_i32x4(_mm_setr_epi32(0xdcb17aa4, 0, 0xb9e02b86, 0));
            y0 = clmul_lo(x0, k), x0 = clmul_hi(x0, k);
            x0 = _mm512_ternarylogic_epi64(x0, y0, x4, 0x96);
            x4 = x8;
            y0 = clmul_lo(x0, k), x0 = clmul_hi(x0, k);
            x0 = _mm512_ternarylogic_epi64(x0, y0, x4, 0x96);
            /* Final scalar chunk. */
            ...
            crc14 = _mm_crc32_u64(crc14, *(const uint64_t *)(buf + klen * 14 + 32));
            crc15 = _mm_crc32_u64(crc15, *(const uint64_t *)(buf + klen * 15 + 32));
            vc0 = crc_shift(crc0, klen * 15 + blk * 1536);
            vc1 = crc_shift(crc1, klen * 14 + blk * 1536);
            vc2 = crc_shift(crc2, klen * 13 + blk * 1536);
            vc3 = crc_shift(crc3, klen * 12 + blk * 1536);
            vc4 = crc_shift(crc4, klen * 11 + blk * 1536);
            vc5 = crc_shift(crc5, klen * 10 + blk * 1536);
            vc6 = crc_shift(crc6, klen * 9 + blk * 1536);
            vc7 = crc_shift(crc7, klen * 8 + blk * 1536);
            vc8 = crc_shift(crc8, klen * 7 + blk * 1536);
            vc9 = crc_shift(crc9, klen * 6 + blk * 1536);
            vc10 = crc_shift(crc10, klen * 5 + blk * 1536);
            vc11 = crc_shift(crc11, klen * 4 + blk * 1536);
            vc12 = crc_shift(crc12, klen * 3 + blk * 1536);
            vc13 = crc_shift(crc13, klen * 2 + blk * 1536);
            vc14 = crc_shift(crc14, klen + blk * 1536);
            vc15 = crc_shift(crc15, 0 + blk * 1536);
            ...
            k = _mm512_setr_epi32(0x1c291d04, 0, 0xddc0152b, 0, 0x3da6d0cb, 0, 0xba4fc28e, 0, 0xf20c0dfe, 0, 0x493c7d27,
                                  0, 0, 0, 0, 0);
            y0 = clmul_lo(x0, k), k = clmul_hi(x0, k);
            y0 = _mm512_xor_si512(y0, k);
            z0 = _mm_ternarylogic_epi64(_mm512_castsi512_si128(y0), _mm512_extracti32x4_epi32(y0, 1),
                                        _mm512_extracti32x4_epi32(y0, 2), 0x96);
