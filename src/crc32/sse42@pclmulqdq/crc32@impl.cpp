...
/* C:\Users\alekesej\Documents\Programming\Tests\fast-crc32\generate.exe -i sse -p crc32c -a v8x2s16x5k64e */
/* MIT licensed */
...
extern "C"
{
    __declspec(dllexport) uint32_t crc32_impl(uint32_t crc0, const char *buf, size_t len)
    {
        ...
        if (len >= 896)
        {
            ...
            y0 = _mm_xor_si128(y0, _mm_loadu_si128((const __m128i *)(buf2 + 128))), x0 = _mm_xor_si128(x0, y0);
            y1 = _mm_xor_si128(y1, _mm_loadu_si128((const __m128i *)(buf2 + 144))), x1 = _mm_xor_si128(x1, y1);
            y2 = _mm_xor_si128(y2, _mm_loadu_si128((const __m128i *)(buf2 + 160))), x2 = _mm_xor_si128(x2, y2);
            y3 = _mm_xor_si128(y3, _mm_loadu_si128((const __m128i *)(buf2 + 176))), x3 = _mm_xor_si128(x3, y3);
            y4 = _mm_xor_si128(y4, _mm_loadu_si128((const __m128i *)(buf2 + 192))), x4 = _mm_xor_si128(x4, y4);
            y5 = _mm_xor_si128(y5, _mm_loadu_si128((const __m128i *)(buf2 + 208))), x5 = _mm_xor_si128(x5, y5);
            y6 = _mm_xor_si128(y6, _mm_loadu_si128((const __m128i *)(buf2 + 224))), x6 = _mm_xor_si128(x6, y6);
            y7 = _mm_xor_si128(y7, _mm_loadu_si128((const __m128i *)(buf2 + 240))), x7 = _mm_xor_si128(x7, y7);
            buf2 += 256;
            /* Main loop. */
            while (buf <= limit)
            {
            ...
            crc14 = _mm_crc32_u64(crc14, *(const uint64_t *)(buf + klen * 14 + 32));
            crc15 = _mm_crc32_u64(crc15, *(const uint64_t *)(buf + klen * 15 + 32));
            vc0 = crc_shift(crc0, klen * 15 + blk * 256);
            vc1 = crc_shift(crc1, klen * 14 + blk * 256);
            vc2 = crc_shift(crc2, klen * 13 + blk * 256);
            vc3 = crc_shift(crc3, klen * 12 + blk * 256);
            vc4 = crc_shift(crc4, klen * 11 + blk * 256);
            vc5 = crc_shift(crc5, klen * 10 + blk * 256);
            vc6 = crc_shift(crc6, klen * 9 + blk * 256);
            vc7 = crc_shift(crc7, klen * 8 + blk * 256);
            vc8 = crc_shift(crc8, klen * 7 + blk * 256);
            vc9 = crc_shift(crc9, klen * 6 + blk * 256);
            vc10 = crc_shift(crc10, klen * 5 + blk * 256);
            vc11 = crc_shift(crc11, klen * 4 + blk * 256);
            vc12 = crc_shift(crc12, klen * 3 + blk * 256);
            vc13 = crc_shift(crc13, klen * 2 + blk * 256);
            vc14 = crc_shift(crc14, klen + blk * 256);
            vc15 = crc_shift(crc15, 0 + blk * 256);
            vc = _mm_extract_epi64(
                _mm_xor_si128(_mm_xor_si128(_mm_xor_si128(_mm_xor_si128(vc0, vc1), _mm_xor_si128(vc2, vc3)),
                                            _mm_xor_si128(_mm_xor_si128(vc4, vc5), _mm_xor_si128(vc6, vc7))),
                              _mm_xor_si128(_mm_xor_si128(_mm_xor_si128(vc8, vc9), _mm_xor_si128(vc10, vc11)),
                                            _mm_xor_si128(_mm_xor_si128(vc12, vc13), _mm_xor_si128(vc14, vc15)))),
                0);
