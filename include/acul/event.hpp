...
namespace acul::events
{
    ...
    {
        unique_function<void(E &)> _listener;

    public:
        explicit listener(unique_function<void(E &)> listener) : _listener(std::move(listener)) {}
    ...
    public:
        ...
        template <class E>
        iterator add_listener(void *owner, u64 id, unique_function<void(E &)> &&fn, int priority = 5)
        {
        ...
        void bind_event(void *owner, u64 id, Listener &&fn, int priority = 5)
        {
            ...
            (void)add_listener<E>(owner, id, unique_function<void(E &)>(std::forward<Listener>(fn)), priority);
        }
        ...
        ACUL_EXPORT void unbind_listener(void *owner, u64 id);
        ACUL_EXPORT void unbind_listeners(void *owner);
