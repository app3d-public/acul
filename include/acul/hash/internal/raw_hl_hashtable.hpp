...
#include "../../pair.hpp"
#if defined(__AVX2__)
    #include "simd/hl_hashmap_avx2.hpp"
#elif defined(__SSE2__)
    #include "simd/hl_hashmap_sse2.hpp"
#else
    #include "simd/hl_hashmap_fallback.hpp"
#endif
...
namespace acul
{
    namespace internal
    {
        ...
        public:
            ...
            {
                return static_cast<size_type>(0x80000000ull * AHM_HL_LOAD_FACTOR / 100);
            }
